...
namespace RecipeManagerCoreMVC.Migrations
{
    ...
    [Migration("20210316041940_seedInitialAdmin")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClaimType = "IsAdmin",
                            ClaimValue = "true",
                            UserId = "42f23ef6-3027-4c2b-aec0-62a7677b6597"
                        });
                });
            ...
            modelBuilder.Entity("RecipeManagerCoreMVC.Data.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "42f23ef6-3027-4c2b-aec0-62a7677b6597",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "6c760586-16d5-4777-93cd-4e422e59126f",
                            Email = "admin@g.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@G.COM",
                            NormalizedUserName = "ADMIN",
                            PasswordHash = "AQAAAAEAACcQAAAAEHzqpI0NchsYD76AjLX26j6Z4+yhCG07L4dUeN9/RGTvxcwcGd0bslfqss4GdFbOJQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "3b881d39-046e-45f7-a250-ab5ffdcca10e",
                            TwoFactorEnabled = false,
                            UserName = "admin"
                        });
                });

            modelBuilder.Entity("RecipeManagerCoreMVC.Models.ArticleModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RecipeManagerCoreMVC.Models.FavoriteModel", b =>
                {
            ...
            modelBuilder.Entity("RecipeManagerCoreMVC.Models.RecipeModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2021, 3, 15, 18, 19, 40, 442, DateTimeKind.Local).AddTicks(3503),
                            RecipeName = "Recipe1",
                            RecipeType = 0
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2021, 3, 15, 18, 19, 40, 442, DateTimeKind.Local).AddTicks(9242),
                            RecipeName = "Recipe2",
                            RecipeType = 0
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2021, 3, 15, 18, 19, 40, 442, DateTimeKind.Local).AddTicks(9254),
                            RecipeName = "Recipe3",
                            RecipeType = 0
                        });
                });
            ...
            modelBuilder.Entity("RecipeManagerCoreMVC.Models.FavoriteModel", b =>
                {
                    ...
                    b.HasOne("RecipeManagerCoreMVC.Data.ApplicationUser", "ApplicationUser")
                        .WithMany("FavoriteModels")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
